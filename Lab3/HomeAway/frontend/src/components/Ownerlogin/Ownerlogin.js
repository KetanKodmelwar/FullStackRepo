...
import {ownerloginUser} from '../../actions/ownerloginActions'
...
class Ownerlogin extends Component{
    ...
    submitLogin = (e) => {
       // var headers = new Headers();
        ...
        this.props.ownerloginUser(data,this.props.history)
                    ...
                    <div className="row" style={{ 'height': '900px','width':'100%','background-color':'#eaece5' }}>
                        <div className="row" style={{ 'height': '180px','width':'100%' }}>
                            ...
                            <div style={{'text-align':'center','width':'100%','margin-left':'150px'}}>
                                ...
                                <Link to="/ownersignup" style={{ textDecoration: 'none' }}>Sign up</Link>
                                </span>
                            </div>
                            </div>
                        </div>
...
export default connect(mapStatetoProps,{ownerloginUser})(Ownerlogin);