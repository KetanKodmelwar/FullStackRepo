                ...
                <div>
                    <div className="row" style={{ 'height': '900px','width':'100%','background-color':'#eaece5' }}>
                        ...
                        <div className='col-md-4' style={{'margin':'25px'}} ></div>
                            <div className='col-md-4' style={{'height':'120%','border':'solid black 1px' ,'padding':'20px','background-color':'#fff'}}>
                                ...
                                <form >
                                    ...
                                    {/* <hr style={{'width':'190px','marginTop':'-100px','position':'relative','color':'grey' }}/><hr style={{'width':'190px','margin-top':'-50px','position':'relative'}}/> */}
                                    <div className="row" style={{'height':'200px','width':'100%','margin-left':'15px'}}>
                                    <input type="Submit"  value="Log in with Facebook" style={{'margin-top':'-80px','vertical-align':'middle','width':'70%','height':'44px','background-color':'#2f4f88','border-color':'1px solid #2f4f88','font-size':'18px','color':'#FFE','text-align':'center','padding':'7px 31px','margin-left':'60px','marginTop':'90px'}}/>
