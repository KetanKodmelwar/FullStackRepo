              ...
              <div className="container my-auto">
                <div className="row">
                  ...
                  <div style={{'paddingLeft': '100px','boxShadow': 'none','display': 'flex','width': '100%','borderRadius': '3px','font-family': 'Lato,Arial,Helvetica Neue,sans-serif','line-height': '1.5rem','color': '#5e6d77','font-size': '16px',}}>
                      ...
                      <span>
                      <input onClick={this.submitSearch} type="submit" value="Search" style={{'display':'block','color': 'white','borderColor': '#005dc5','background-color': '#005dc5','minHeight': '48px','position': 'relative','borderRadius': '100px','boxShadow': 'none','font-weight': '400','text-align': 'center','verticalAlign': 'middle','padding': '11px 32px'}}/>
                      </span>
                  </div>
