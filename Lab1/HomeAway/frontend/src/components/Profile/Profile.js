    ...
    submitProfile = (e) => {
     ...
     .then(response => {
         ...
         if(response.status === 200){
             console.log("Profile data entered properly",response);
         }else{
                            ...
                            <div className='col-md-1' ></div>
                                ...
                                <div className="row" style={{'height':'660px','width':'100%'}}>
                                    <div className='row' style={{'height':'125px','width':'100%','margin-left':'15px'}}>
                                        ...
                                        <textarea value={this.state.aaboutMe} onChange={this.aboutMeChangeHandler} name="AboutMe" placeholder="About Me" rows="5" cols="20" style={{'margin-left':'1px','width': '100%','padding':  '9px 14px','font-size':  '18px','border-radius':  '0px','line-height':  '1.33','margin-top':  '16px'}}/>
                                        ...
                                        <Link to="/" style={{'text-decoration':'none'}}><input onClick={this.submitProfile} type="submit" value="Save Changes" style={{'display':'block','color': 'white','border-color': '#2f4f88','background-color': '#2f4f88','min-height': '48px','position': 'relative','border-radius': '100px','box-shadow': 'none','font-weight': '400','text-align': 'center','vertical-align': 'middle','padding': '11px 32px'}}/></Link>
                                        </span>
