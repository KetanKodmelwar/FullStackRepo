...
class ListMyProperty extends Component{
    ...
    render(){
               ...
               <div className="row" style={{ 'height': '60px' ,'margin':'50px'}}>
                    ...
                    <div style={{'top':'20px','right':'150px','position':'absolute'}}>
                       <select style={{'cursor': 'pointer','height': '50px','padding': '0 25px','font-weight': '500','font-size': '15px','line-height': '61px','font-family': 'Lato,Arial,Helvetica Neue,sans-serif','color': '#5e6d77'}}>
                           ...
                           <option value="Signout" style={{'color':'black','font-weight': '400','font-size': '16px','padding': '10px 20px','white-space': 'nowrap','font-family': 'Open Sans,Helvetica Neue,Arial,sans-serif'}}>Sign Out</option>
                           </select> 
                    </div>
        ...
        <div className="col-md-8" style={{'background-color':'#f5f5f0', 'height':'650px','margin-top':'10px','width':'1000px'}}>
                                
                                
                            
        <TabPanel tabId="vertical-tab-one" eventKey={1}>
            <ul>
                <h3>Welcome to post your property. Complete the following steps for your further process</h3>
        ...
        <TabPanel tabId="vertical-tab-two" eventKey={2}>
        <ul>
        ...
        <TabPanel tabId="vertical-tab-four" eventKey={4}>
        <ul>
                            ...
                            <h5>Showcase your property's best features. Requirements:JPEG </h5>
                                ...
                                <input type="file" name="selectedFile" onChange={this.addPics}  style={{'vertical-align':'middle','width':'20%','height':'44px','background-color':'light-grey','border-color':'light-grey','font-size':'18px','color':'black','padding':' 7px 31px','text-align':'center'}} multiple/>
                                </form>
                                </span>
                           <div>
                           <input type="submit" value="Add Pics" onClick={this.picsSubmit} style={{'margin-left':'5px','vertical-align':'middle','width':'20%','height':'44px','background-color':'#ff8a00','border-color':'#ff8a00','font-size':'18px','color':'#FFE','padding':' 7px 31px','text-align':'center'}}/>
                               </div>
                            <div>
                                <input type="submit" value="Back"  style={{'vertical-align':'middle','width':'20%','height':'44px','background-color':'light-grey','border-color':'light-grey','font-size':'18px','color':'black','padding':' 7px 31px','text-align':'center'}}/>
                                <input type="submit" value="Next"  style={{'margin-left':'5px','vertical-align':'middle','width':'20%','height':'44px','background-color':'#ff8a00','border-color':'#ff8a00','font-size':'18px','color':'#FFE','padding':' 7px 31px','text-align':'center'}}/>
        ...
        <TabPanel tabId="vertical-tab-five" eventKey={5}>
        <ul>
                        <h3> Block the dates when you want your property to be listed</h3>
                        
                        <div>
                            <span style={{'display':'block'}}>
                            Start Date: <input type="date" name="arrivedate" placeholder="Arrive Date" onChange={this.arriveDateHandler} style={{'margin-bottom':'10px','width': '40%','height': '44px','padding':  '9px 14px','font-size':  '18px','border-radius':  '0px','line-height':  '1.33','margin-top':  '16px'}} />
                            </span>
                            <span style={{'display':'block'}}>
                            End Date :   <input type="date" name="checkoutdate" placeholder="Checkout Date" onChange={this.checkoutDateHandler} style={{'margin-bottom':'10px','width': '40%','height': '44px','padding':  '9px 14px','font-size':  '18px','border-radius':  '0px','line-height':  '1.33','margin-top':  '16px'}} />
                            </span>
                        </div>
